...
export const productPages: ProductPage[] = [
  ...
  // ── Flexi Mecha Dragon ──────────────────────────────────────────────────────
  {
    ...
    availableFilamentColorIds: ['white', 'black', 'red', 'green', 'blue', 'orange', 'purple', 'pink', 'teal', 'gray'],
    customizationOptions: { engravingText: false, keychainHole: false },
    printLeadTime: '3–5 business days',
    variants: [
      { sku: '3DP-FMD-WHT', name: 'Flexi Mecha Dragon', variant: 'Arctic White',  color: 'Arctic White',  colorHex: '#F8F8F8', filamentColorId: 'white',  price: 24.99, image: '/images/products/flexi-mecha-dragon.jpg', inventory: 999 },
      { sku: '3DP-FMD-BLK', name: 'Flexi Mecha Dragon', variant: 'Midnight Black', color: 'Midnight Black', colorHex: '#1A1A1A', filamentColorId: 'black',  price: 24.99, image: '/images/products/flexi-mecha-dragon.jpg', inventory: 999 },
      { sku: '3DP-FMD-RED', name: 'Flexi Mecha Dragon', variant: 'Crimson Red',   color: 'Crimson Red',   colorHex: '#EF4444', filamentColorId: 'red',    price: 24.99, image: '/images/products/flexi-mecha-dragon.jpg', inventory: 999 },
      { sku: '3DP-FMD-GRN', name: 'Flexi Mecha Dragon', variant: 'Forest Green',  color: 'Forest Green',  colorHex: '#22C55E', filamentColorId: 'green',  price: 24.99, image: '/images/products/flexi-mecha-dragon.jpg', inventory: 999 },
      { sku: '3DP-FMD-BLU', name: 'Flexi Mecha Dragon', variant: 'Ocean Blue',    color: 'Ocean Blue',    colorHex: '#3B82F6', filamentColorId: 'blue',   price: 24.99, image: '/images/products/flexi-mecha-dragon.jpg', inventory: 999 },
      { sku: '3DP-FMD-ORG', name: 'Flexi Mecha Dragon', variant: 'Sunset Orange', color: 'Sunset Orange', colorHex: '#F97316', filamentColorId: 'orange', price: 24.99, image: '/images/products/flexi-mecha-dragon.jpg', inventory: 999 },
      { sku: '3DP-FMD-PRP', name: 'Flexi Mecha Dragon', variant: 'Royal Purple',  color: 'Royal Purple',  colorHex: '#A855F7', filamentColorId: 'purple', price: 24.99, image: '/images/products/flexi-mecha-dragon.jpg', inventory: 999 },
    ],
    defaultVariantIndex: 0,
    ...
    features: [
      ...
      'Made to order — printed in-house',
      'Available in 7 filament colors',
    ],
    specifications: {
      'Material': 'PLA Filament',
      'Print Style': 'Print-in-place (no assembly)',
  ...
  // ── Cute Snakey ─────────────────────────────────────────────────────────────
  {
    ...
    availableFilamentColorIds: ['white', 'black', 'red', 'orange', 'yellow', 'green', 'blue', 'purple', 'pink', 'teal'],
    customizationOptions: { engravingText: false, keychainHole: false },
    printLeadTime: '3–5 business days',
    variants: [
      { sku: '3DP-SNKY-WHT', name: 'Cute Snakey', variant: 'Arctic White',  color: 'Arctic White',  colorHex: '#F8F8F8', filamentColorId: 'white',  price: 14.99, image: '/images/products/cute-snakey.jpg', inventory: 999 },
      { sku: '3DP-SNKY-BLK', name: 'Cute Snakey', variant: 'Midnight Black', color: 'Midnight Black', colorHex: '#1A1A1A', filamentColorId: 'black',  price: 14.99, image: '/images/products/cute-snakey.jpg', inventory: 999 },
      { sku: '3DP-SNKY-RED', name: 'Cute Snakey', variant: 'Crimson Red',   color: 'Crimson Red',   colorHex: '#EF4444', filamentColorId: 'red',    price: 14.99, image: '/images/products/cute-snakey.jpg', inventory: 999 },
      { sku: '3DP-SNKY-ORG', name: 'Cute Snakey', variant: 'Sunset Orange', color: 'Sunset Orange', colorHex: '#F97316', filamentColorId: 'orange', price: 14.99, image: '/images/products/cute-snakey.jpg', inventory: 999 },
      { sku: '3DP-SNKY-YLW', name: 'Cute Snakey', variant: 'Solar Yellow',  color: 'Solar Yellow',  colorHex: '#EAB308', filamentColorId: 'yellow', price: 14.99, image: '/images/products/cute-snakey.jpg', inventory: 999 },
      { sku: '3DP-SNKY-GRN', name: 'Cute Snakey', variant: 'Forest Green',  color: 'Forest Green',  colorHex: '#22C55E', filamentColorId: 'green',  price: 14.99, image: '/images/products/cute-snakey.jpg', inventory: 999 },
      { sku: '3DP-SNKY-BLU', name: 'Cute Snakey', variant: 'Ocean Blue',    color: 'Ocean Blue',    colorHex: '#3B82F6', filamentColorId: 'blue',   price: 14.99, image: '/images/products/cute-snakey.jpg', inventory: 999 },
      { sku: '3DP-SNKY-PRP', name: 'Cute Snakey', variant: 'Royal Purple',  color: 'Royal Purple',  colorHex: '#A855F7', filamentColorId: 'purple', price: 14.99, image: '/images/products/cute-snakey.jpg', inventory: 999 },
      { sku: '3DP-SNKY-PNK', name: 'Cute Snakey', variant: 'Hot Pink',      color: 'Hot Pink',      colorHex: '#EC4899', filamentColorId: 'pink',   price: 14.99, image: '/images/products/cute-snakey.jpg', inventory: 999 },
      { sku: '3DP-SNKY-TEL', name: 'Cute Snakey', variant: 'Electric Teal', color: 'Electric Teal', colorHex: '#14B8A6', filamentColorId: 'teal',   price: 14.99, image: '/images/products/cute-snakey.jpg', inventory: 999 },
    ],
    defaultVariantIndex: 0,
    ...
    features: [
      ...
      'Made to order — printed in-house',
      'Available in 10 filament colors',
    ],
    specifications: {
      'Material': 'PLA Filament',
    ...
    metaDescription: 'A cute, wiggly articulated snake fidget toy — every link moves. Available in mini, standard, and extra long. Made to order in 10 colors.',
  },
  ...
  // ── Spiral Cone Fidget ───────────────────────────────────────────────────────
  {
    ...
    availableFilamentColorIds: ['white', 'black', 'red', 'orange', 'green', 'blue', 'purple', 'pink', 'teal', 'gray'],
    multiColorParts: [
    ...
    printLeadTime: '3–5 business days',
    variants: [
      { sku: '3DP-SCF-WHT', name: 'Spiral Cone Fidget', variant: 'Arctic White',  color: 'Arctic White',  colorHex: '#F8F8F8', filamentColorId: 'white',  price: 14.99, image: '/images/products/spiral-cone-fidget.jpg', inventory: 999 },
      { sku: '3DP-SCF-BLK', name: 'Spiral Cone Fidget', variant: 'Midnight Black', color: 'Midnight Black', colorHex: '#1A1A1A', filamentColorId: 'black',  price: 14.99, image: '/images/products/spiral-cone-fidget.jpg', inventory: 999 },
      { sku: '3DP-SCF-RED', name: 'Spiral Cone Fidget', variant: 'Crimson Red',   color: 'Crimson Red',   colorHex: '#EF4444', filamentColorId: 'red',    price: 14.99, image: '/images/products/spiral-cone-fidget.jpg', inventory: 999 },
      { sku: '3DP-SCF-ORG', name: 'Spiral Cone Fidget', variant: 'Sunset Orange', color: 'Sunset Orange', colorHex: '#F97316', filamentColorId: 'orange', price: 14.99, image: '/images/products/spiral-cone-fidget.jpg', inventory: 999 },
      { sku: '3DP-SCF-GRN', name: 'Spiral Cone Fidget', variant: 'Forest Green',  color: 'Forest Green',  colorHex: '#22C55E', filamentColorId: 'green',  price: 14.99, image: '/images/products/spiral-cone-fidget.jpg', inventory: 999 },
      { sku: '3DP-SCF-BLU', name: 'Spiral Cone Fidget', variant: 'Ocean Blue',    color: 'Ocean Blue',    colorHex: '#3B82F6', filamentColorId: 'blue',   price: 14.99, image: '/images/products/spiral-cone-fidget.jpg', inventory: 999 },
      { sku: '3DP-SCF-PRP', name: 'Spiral Cone Fidget', variant: 'Royal Purple',  color: 'Royal Purple',  colorHex: '#A855F7', filamentColorId: 'purple', price: 14.99, image: '/images/products/spiral-cone-fidget.jpg', inventory: 999 },
      { sku: '3DP-SCF-PNK', name: 'Spiral Cone Fidget', variant: 'Hot Pink',      color: 'Hot Pink',      colorHex: '#EC4899', filamentColorId: 'pink',   price: 14.99, image: '/images/products/spiral-cone-fidget.jpg', inventory: 999 },
      { sku: '3DP-SCF-TEL', name: 'Spiral Cone Fidget', variant: 'Electric Teal', color: 'Electric Teal', colorHex: '#14B8A6', filamentColorId: 'teal',   price: 14.99, image: '/images/products/spiral-cone-fidget.jpg', inventory: 999 },
      { sku: '3DP-SCF-GRY', name: 'Spiral Cone Fidget', variant: 'Slate Gray',    color: 'Slate Gray',    colorHex: '#94A3B8', filamentColorId: 'gray',   price: 14.99, image: '/images/products/spiral-cone-fidget.jpg', inventory: 999 },
    ],
    defaultVariantIndex: 0,
    ...
    metaDescription: 'A mesmerizing spiral passthrough fidget toy — 8.5cm tall with satisfying cascading ring motion. Made to order in 10 colors.',
  },
  ...
  // ── The Rocktopus ────────────────────────────────────────────────────────────
  {
    ...
    printLeadTime: '3–5 business days',
    variants: [
      { sku: '3DP-RKTPS-WHT', name: 'The Rocktopus', variant: 'Arctic White',  color: 'Arctic White',  colorHex: '#F8F8F8', filamentColorId: 'white',  price: 19.99, image: '/images/products/rocktopus.jpg', inventory: 999 },
      { sku: '3DP-RKTPS-BLK', name: 'The Rocktopus', variant: 'Midnight Black', color: 'Midnight Black', colorHex: '#1A1A1A', filamentColorId: 'black',  price: 19.99, image: '/images/products/rocktopus.jpg', inventory: 999 },
      { sku: '3DP-RKTPS-RED', name: 'The Rocktopus', variant: 'Crimson Red',   color: 'Crimson Red',   colorHex: '#EF4444', filamentColorId: 'red',    price: 19.99, image: '/images/products/rocktopus.jpg', inventory: 999 },
      { sku: '3DP-RKTPS-ORG', name: 'The Rocktopus', variant: 'Sunset Orange', color: 'Sunset Orange', colorHex: '#F97316', filamentColorId: 'orange', price: 19.99, image: '/images/products/rocktopus.jpg', inventory: 999 },
      { sku: '3DP-RKTPS-GRN', name: 'The Rocktopus', variant: 'Forest Green',  color: 'Forest Green',  colorHex: '#22C55E', filamentColorId: 'green',  price: 19.99, image: '/images/products/rocktopus.jpg', inventory: 999 },
      { sku: '3DP-RKTPS-BLU', name: 'The Rocktopus', variant: 'Ocean Blue',    color: 'Ocean Blue',    colorHex: '#3B82F6', filamentColorId: 'blue',   price: 19.99, image: '/images/products/rocktopus.jpg', inventory: 999 },
      { sku: '3DP-RKTPS-PRP', name: 'The Rocktopus', variant: 'Royal Purple',  color: 'Royal Purple',  colorHex: '#A855F7', filamentColorId: 'purple', price: 19.99, image: '/images/products/rocktopus.jpg', inventory: 999 },
      { sku: '3DP-RKTPS-PNK', name: 'The Rocktopus', variant: 'Hot Pink',      color: 'Hot Pink',      colorHex: '#EC4899', filamentColorId: 'pink',   price: 19.99, image: '/images/products/rocktopus.jpg', inventory: 999 },
      { sku: '3DP-RKTPS-TEL', name: 'The Rocktopus', variant: 'Electric Teal', color: 'Electric Teal', colorHex: '#14B8A6', filamentColorId: 'teal',   price: 19.99, image: '/images/products/rocktopus.jpg', inventory: 999 },
      { sku: '3DP-RKTPS-GRY', name: 'The Rocktopus', variant: 'Slate Gray',    color: 'Slate Gray',    colorHex: '#94A3B8', filamentColorId: 'gray',   price: 19.99, image: '/images/products/rocktopus.jpg', inventory: 999 },
    ],
    defaultVariantIndex: 0,
    ...
    metaDescription: 'The Rocktopus — a fully articulated octopus with an iconic face. All 8 tentacles move. No supports needed. Made to order in 10 colors.',
  },
  ...
  // ── Cute Octopus (v3) ────────────────────────────────────────────────────────
  {
    ...
    printLeadTime: '3–5 business days',
    variants: [
      { sku: '3DP-COCT-WHT', name: 'Cute Octopus', variant: 'Arctic White',  color: 'Arctic White',  colorHex: '#F8F8F8', filamentColorId: 'white',  price: 17.99, image: '/images/products/cute-octopus.jpg', inventory: 999 },
      { sku: '3DP-COCT-BLK', name: 'Cute Octopus', variant: 'Midnight Black', color: 'Midnight Black', colorHex: '#1A1A1A', filamentColorId: 'black',  price: 17.99, image: '/images/products/cute-octopus.jpg', inventory: 999 },
      { sku: '3DP-COCT-RED', name: 'Cute Octopus', variant: 'Crimson Red',   color: 'Crimson Red',   colorHex: '#EF4444', filamentColorId: 'red',    price: 17.99, image: '/images/products/cute-octopus.jpg', inventory: 999 },
      { sku: '3DP-COCT-ORG', name: 'Cute Octopus', variant: 'Sunset Orange', color: 'Sunset Orange', colorHex: '#F97316', filamentColorId: 'orange', price: 17.99, image: '/images/products/cute-octopus.jpg', inventory: 999 },
      { sku: '3DP-COCT-YLW', name: 'Cute Octopus', variant: 'Solar Yellow',  color: 'Solar Yellow',  colorHex: '#EAB308', filamentColorId: 'yellow', price: 17.99, image: '/images/products/cute-octopus.jpg', inventory: 999 },
      { sku: '3DP-COCT-GRN', name: 'Cute Octopus', variant: 'Forest Green',  color: 'Forest Green',  colorHex: '#22C55E', filamentColorId: 'green',  price: 17.99, image: '/images/products/cute-octopus.jpg', inventory: 999 },
      { sku: '3DP-COCT-BLU', name: 'Cute Octopus', variant: 'Ocean Blue',    color: 'Ocean Blue',    colorHex: '#3B82F6', filamentColorId: 'blue',   price: 17.99, image: '/images/products/cute-octopus.jpg', inventory: 999 },
      { sku: '3DP-COCT-PRP', name: 'Cute Octopus', variant: 'Royal Purple',  color: 'Royal Purple',  colorHex: '#A855F7', filamentColorId: 'purple', price: 17.99, image: '/images/products/cute-octopus.jpg', inventory: 999 },
      { sku: '3DP-COCT-PNK', name: 'Cute Octopus', variant: 'Hot Pink',      color: 'Hot Pink',      colorHex: '#EC4899', filamentColorId: 'pink',   price: 17.99, image: '/images/products/cute-octopus.jpg', inventory: 999 },
      { sku: '3DP-COCT-TEL', name: 'Cute Octopus', variant: 'Electric Teal', color: 'Electric Teal', colorHex: '#14B8A6', filamentColorId: 'teal',   price: 17.99, image: '/images/products/cute-octopus.jpg', inventory: 999 },
    ],
    defaultVariantIndex: 0,
    ...
    metaDescription: 'A fully articulated cute octopus with 8 wiggly tentacles — no supports, reliable print. Made to order in 10 colors.',
  },
  ...
  // ── Flex Slug ────────────────────────────────────────────────────────────────
  {
    ...
    printLeadTime: '3–5 business days',
    variants: [
      { sku: '3DP-SLUG-WHT', name: 'Flex Slug', variant: 'Arctic White',  color: 'Arctic White',  colorHex: '#F8F8F8', filamentColorId: 'white',  price: 16.99, image: '/images/products/flex-slug.jpg', inventory: 999 },
      { sku: '3DP-SLUG-BLK', name: 'Flex Slug', variant: 'Midnight Black', color: 'Midnight Black', colorHex: '#1A1A1A', filamentColorId: 'black',  price: 16.99, image: '/images/products/flex-slug.jpg', inventory: 999 },
      { sku: '3DP-SLUG-RED', name: 'Flex Slug', variant: 'Crimson Red',   color: 'Crimson Red',   colorHex: '#EF4444', filamentColorId: 'red',    price: 16.99, image: '/images/products/flex-slug.jpg', inventory: 999 },
      { sku: '3DP-SLUG-ORG', name: 'Flex Slug', variant: 'Sunset Orange', color: 'Sunset Orange', colorHex: '#F97316', filamentColorId: 'orange', price: 16.99, image: '/images/products/flex-slug.jpg', inventory: 999 },
      { sku: '3DP-SLUG-YLW', name: 'Flex Slug', variant: 'Solar Yellow',  color: 'Solar Yellow',  colorHex: '#EAB308', filamentColorId: 'yellow', price: 16.99, image: '/images/products/flex-slug.jpg', inventory: 999 },
      { sku: '3DP-SLUG-GRN', name: 'Flex Slug', variant: 'Forest Green',  color: 'Forest Green',  colorHex: '#22C55E', filamentColorId: 'green',  price: 16.99, image: '/images/products/flex-slug.jpg', inventory: 999 },
      { sku: '3DP-SLUG-BLU', name: 'Flex Slug', variant: 'Ocean Blue',    color: 'Ocean Blue',    colorHex: '#3B82F6', filamentColorId: 'blue',   price: 16.99, image: '/images/products/flex-slug.jpg', inventory: 999 },
      { sku: '3DP-SLUG-PRP', name: 'Flex Slug', variant: 'Royal Purple',  color: 'Royal Purple',  colorHex: '#A855F7', filamentColorId: 'purple', price: 16.99, image: '/images/products/flex-slug.jpg', inventory: 999 },
      { sku: '3DP-SLUG-PNK', name: 'Flex Slug', variant: 'Hot Pink',      color: 'Hot Pink',      colorHex: '#EC4899', filamentColorId: 'pink',   price: 16.99, image: '/images/products/flex-slug.jpg', inventory: 999 },
      { sku: '3DP-SLUG-TEL', name: 'Flex Slug', variant: 'Electric Teal', color: 'Electric Teal', colorHex: '#14B8A6', filamentColorId: 'teal',   price: 16.99, image: '/images/products/flex-slug.jpg', inventory: 999 },
    ],
    defaultVariantIndex: 0,
    ...
    metaDescription: 'A fully articulated flex slug fidget toy — satisfying wave motion, printed at 150% scale. Made to order in 10 colors.',
  },
  ...
  // ── Octopus Long Tentacles ───────────────────────────────────────────────────
  {
    ...
    printLeadTime: '3–5 business days',
    variants: [
      { sku: '3DP-OCTTNT-WHT', name: 'Octopus — Long Tentacles', variant: 'Arctic White',  color: 'Arctic White',  colorHex: '#F8F8F8', filamentColorId: 'white',  price: 19.99, image: '/images/products/octopus-long-tentacles.jpg', inventory: 999 },
      { sku: '3DP-OCTTNT-BLK', name: 'Octopus — Long Tentacles', variant: 'Midnight Black', color: 'Midnight Black', colorHex: '#1A1A1A', filamentColorId: 'black',  price: 19.99, image: '/images/products/octopus-long-tentacles.jpg', inventory: 999 },
      { sku: '3DP-OCTTNT-RED', name: 'Octopus — Long Tentacles', variant: 'Crimson Red',   color: 'Crimson Red',   colorHex: '#EF4444', filamentColorId: 'red',    price: 19.99, image: '/images/products/octopus-long-tentacles.jpg', inventory: 999 },
      { sku: '3DP-OCTTNT-ORG', name: 'Octopus — Long Tentacles', variant: 'Sunset Orange', color: 'Sunset Orange', colorHex: '#F97316', filamentColorId: 'orange', price: 19.99, image: '/images/products/octopus-long-tentacles.jpg', inventory: 999 },
      { sku: '3DP-OCTTNT-YLW', name: 'Octopus — Long Tentacles', variant: 'Solar Yellow',  color: 'Solar Yellow',  colorHex: '#EAB308', filamentColorId: 'yellow', price: 19.99, image: '/images/products/octopus-long-tentacles.jpg', inventory: 999 },
      { sku: '3DP-OCTTNT-GRN', name: 'Octopus — Long Tentacles', variant: 'Forest Green',  color: 'Forest Green',  colorHex: '#22C55E', filamentColorId: 'green',  price: 19.99, image: '/images/products/octopus-long-tentacles.jpg', inventory: 999 },
      { sku: '3DP-OCTTNT-BLU', name: 'Octopus — Long Tentacles', variant: 'Ocean Blue',    color: 'Ocean Blue',    colorHex: '#3B82F6', filamentColorId: 'blue',   price: 19.99, image: '/images/products/octopus-long-tentacles.jpg', inventory: 999 },
      { sku: '3DP-OCTTNT-PRP', name: 'Octopus — Long Tentacles', variant: 'Royal Purple',  color: 'Royal Purple',  colorHex: '#A855F7', filamentColorId: 'purple', price: 19.99, image: '/images/products/octopus-long-tentacles.jpg', inventory: 999 },
      { sku: '3DP-OCTTNT-PNK', name: 'Octopus — Long Tentacles', variant: 'Hot Pink',      color: 'Hot Pink',      colorHex: '#EC4899', filamentColorId: 'pink',   price: 19.99, image: '/images/products/octopus-long-tentacles.jpg', inventory: 999 },
      { sku: '3DP-OCTTNT-TEL', name: 'Octopus — Long Tentacles', variant: 'Electric Teal', color: 'Electric Teal', colorHex: '#14B8A6', filamentColorId: 'teal',   price: 19.99, image: '/images/products/octopus-long-tentacles.jpg', inventory: 999 },
    ],
    defaultVariantIndex: 0,
    ...
    metaDescription: 'A dramatic articulated octopus with extra-long tentacles — all 8 move independently. Made to order in 10 colors.',
  },
  ...
  // ── F-35 Lightning II ────────────────────────────────────────────────────────
  {
    ...
    availableFilamentColorIds: ['white', 'black', 'gray'],
    customizationOptions: { engravingText: false, keychainHole: false },
    printLeadTime: '5–7 business days',
    variants: [
      { sku: '3DP-F35-WHT', name: 'F-35 Lightning II', variant: 'Arctic White', color: 'Arctic White', colorHex: '#F8F8F8', filamentColorId: 'white', price: 34.99, image: '/images/products/f35-lightning.jpg', inventory: 999 },
      { sku: '3DP-F35-BLK', name: 'F-35 Lightning II', variant: 'Midnight Black', color: 'Midnight Black', colorHex: '#1A1A1A', filamentColorId: 'black', price: 34.99, image: '/images/products/f35-lightning.jpg', inventory: 999 },
      { sku: '3DP-F35-GRY', name: 'F-35 Lightning II', variant: 'Slate Gray', color: 'Slate Gray', colorHex: '#94A3B8', filamentColorId: 'gray', price: 34.99, image: '/images/products/f35-lightning.jpg', inventory: 999 },
    ],
    ...
    features: [
      ...
      'Available in White, Black, or Slate Gray',
    ],
    specifications: {
      'Material': 'PLA Filament',
    ...
    metaDescription: 'A highly detailed 3D-printed F-35 Lightning II scale model (~27 cm) with display stand. Made to order in White, Black, or Gray.',
  },
  ...
  // ── 7-Ring Gyro Spinner Fidget ───────────────────────────────────────────────
  {
    ...
    printLeadTime: '3–5 business days',
    variants: [
      { sku: '3DP-GYRO7-WHT', name: '7-Ring Gyro Spinner', variant: 'Arctic White',  color: 'Arctic White',  colorHex: '#F8F8F8', filamentColorId: 'white',  price: 17.99, image: '/images/products/gyro-spinner-7.jpg', inventory: 999 },
      { sku: '3DP-GYRO7-BLK', name: '7-Ring Gyro Spinner', variant: 'Midnight Black', color: 'Midnight Black', colorHex: '#1A1A1A', filamentColorId: 'black',  price: 17.99, image: '/images/products/gyro-spinner-7.jpg', inventory: 999 },
      { sku: '3DP-GYRO7-RED', name: '7-Ring Gyro Spinner', variant: 'Crimson Red',   color: 'Crimson Red',   colorHex: '#EF4444', filamentColorId: 'red',    price: 17.99, image: '/images/products/gyro-spinner-7.jpg', inventory: 999 },
      { sku: '3DP-GYRO7-ORG', name: '7-Ring Gyro Spinner', variant: 'Sunset Orange', color: 'Sunset Orange', colorHex: '#F97316', filamentColorId: 'orange', price: 17.99, image: '/images/products/gyro-spinner-7.jpg', inventory: 999 },
      { sku: '3DP-GYRO7-GRN', name: '7-Ring Gyro Spinner', variant: 'Forest Green',  color: 'Forest Green',  colorHex: '#22C55E', filamentColorId: 'green',  price: 17.99, image: '/images/products/gyro-spinner-7.jpg', inventory: 999 },
      { sku: '3DP-GYRO7-BLU', name: '7-Ring Gyro Spinner', variant: 'Ocean Blue',    color: 'Ocean Blue',    colorHex: '#3B82F6', filamentColorId: 'blue',   price: 17.99, image: '/images/products/gyro-spinner-7.jpg', inventory: 999 },
      { sku: '3DP-GYRO7-PRP', name: '7-Ring Gyro Spinner', variant: 'Royal Purple',  color: 'Royal Purple',  colorHex: '#A855F7', filamentColorId: 'purple', price: 17.99, image: '/images/products/gyro-spinner-7.jpg', inventory: 999 },
      { sku: '3DP-GYRO7-PNK', name: '7-Ring Gyro Spinner', variant: 'Hot Pink',      color: 'Hot Pink',      colorHex: '#EC4899', filamentColorId: 'pink',   price: 17.99, image: '/images/products/gyro-spinner-7.jpg', inventory: 999 },
      { sku: '3DP-GYRO7-TEL', name: '7-Ring Gyro Spinner', variant: 'Electric Teal', color: 'Electric Teal', colorHex: '#14B8A6', filamentColorId: 'teal',   price: 17.99, image: '/images/products/gyro-spinner-7.jpg', inventory: 999 },
      { sku: '3DP-GYRO7-GRY', name: '7-Ring Gyro Spinner', variant: 'Slate Gray',    color: 'Slate Gray',    colorHex: '#94A3B8', filamentColorId: 'gray',   price: 17.99, image: '/images/products/gyro-spinner-7.jpg', inventory: 999 },
    ],
    defaultVariantIndex: 0,
    ...
    metaDescription: 'A 7-ring gyro spinner fidget with all rings spinning freely — print-in-place, no assembly. Made to order in 10 colors.',
  },

  {
    ...
    availableFilamentColorIds: ['white', 'black', 'red', 'orange', 'yellow', 'green', 'blue', 'purple', 'pink', 'teal', 'gray'],
    customizationOptions: {
      engravingText: false,
      keychainHole: false,
    },
    printLeadTime: '3–5 business days',
    variants: [
      { sku: '3DP-KCF-WHT', name: 'Keyboard Clicker Fidget', variant: 'Arctic White',  color: 'Arctic White',  colorHex: '#F8F8F8', filamentColorId: 'white',  price: 14.99, image: '/images/products/keyboard-clicker-fidget.jpg', inventory: 999 },
      { sku: '3DP-KCF-BLK', name: 'Keyboard Clicker Fidget', variant: 'Midnight Black', color: 'Midnight Black', colorHex: '#1A1A1A', filamentColorId: 'black',  price: 14.99, image: '/images/products/keyboard-clicker-fidget.jpg', inventory: 999 },
      { sku: '3DP-KCF-RED', name: 'Keyboard Clicker Fidget', variant: 'Crimson Red',   color: 'Crimson Red',   colorHex: '#EF4444', filamentColorId: 'red',    price: 14.99, image: '/images/products/keyboard-clicker-fidget.jpg', inventory: 999 },
      { sku: '3DP-KCF-ORG', name: 'Keyboard Clicker Fidget', variant: 'Sunset Orange', color: 'Sunset Orange', colorHex: '#F97316', filamentColorId: 'orange', price: 14.99, image: '/images/products/keyboard-clicker-fidget.jpg', inventory: 999 },
      { sku: '3DP-KCF-YLW', name: 'Keyboard Clicker Fidget', variant: 'Solar Yellow',  color: 'Solar Yellow',  colorHex: '#EAB308', filamentColorId: 'yellow', price: 14.99, image: '/images/products/keyboard-clicker-fidget.jpg', inventory: 999 },
      { sku: '3DP-KCF-GRN', name: 'Keyboard Clicker Fidget', variant: 'Forest Green',  color: 'Forest Green',  colorHex: '#22C55E', filamentColorId: 'green',  price: 14.99, image: '/images/products/keyboard-clicker-fidget.jpg', inventory: 999 },
      { sku: '3DP-KCF-BLU', name: 'Keyboard Clicker Fidget', variant: 'Ocean Blue',    color: 'Ocean Blue',    colorHex: '#3B82F6', filamentColorId: 'blue',   price: 14.99, image: '/images/products/keyboard-clicker-fidget.jpg', inventory: 999 },
      { sku: '3DP-KCF-PRP', name: 'Keyboard Clicker Fidget', variant: 'Royal Purple',  color: 'Royal Purple',  colorHex: '#A855F7', filamentColorId: 'purple', price: 14.99, image: '/images/products/keyboard-clicker-fidget.jpg', inventory: 999 },
      { sku: '3DP-KCF-PNK', name: 'Keyboard Clicker Fidget', variant: 'Hot Pink',      color: 'Hot Pink',      colorHex: '#EC4899', filamentColorId: 'pink',   price: 14.99, image: '/images/products/keyboard-clicker-fidget.jpg', inventory: 999 },
      { sku: '3DP-KCF-TEL', name: 'Keyboard Clicker Fidget', variant: 'Electric Teal', color: 'Electric Teal', colorHex: '#14B8A6', filamentColorId: 'teal',   price: 14.99, image: '/images/products/keyboard-clicker-fidget.jpg', inventory: 999 },
      { sku: '3DP-KCF-GRY', name: 'Keyboard Clicker Fidget', variant: 'Slate Gray',    color: 'Slate Gray',    colorHex: '#94A3B8', filamentColorId: 'gray',   price: 14.99, image: '/images/products/keyboard-clicker-fidget.jpg', inventory: 999 },
    ],
    defaultVariantIndex: 0,
...
<p>The low-profile design fits naturally between your fingers and thumb, with a generously sized keycap that gives you a clean, confident press every time. Every unit is made to order in your choice of 11 filament colors.</p>`,
    features: [
      ...
      'Made to order in 11 filament colors',
    ],
    specifications: {
    ...
    metaDescription: 'A pocket-sized fidget with a real Cherry MX-compatible mechanical switch — satisfying click and tactile bump in 11 colors.',
  },
