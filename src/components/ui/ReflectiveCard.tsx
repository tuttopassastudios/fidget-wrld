...
function ReflectiveCardInner({
  ...
  return (
    <div ref={wrapRef} className={`reflective-wrapper ${className}`.trim()}>
      <div className="reflective-glow" />
      <div ref={shellRef} className="reflective-shell">
        {children}
...
export const ReflectiveCard = React.memo(ReflectiveCardInner);
