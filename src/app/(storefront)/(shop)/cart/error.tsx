  ...
  return (
    <section className="product-page" style={{ padding: '80px 0', textAlign: 'center' }}>
      <div className="container" style={{ maxWidth: 500, margin: '0 auto' }}>
        ...
        <h1 style={{ marginBottom: 8 }}>Cart Error</h1>
        <p style={{ color: 'var(--color-text-muted)', marginBottom: 24, fontSize: 14 }}>
          Your cart encountered an error. You can try again or clear your cart to start fresh.
        </p>
        ...
        <div style={{ marginTop: 16 }}>
          <Link href="/products" style={{ color: 'var(--color-accent-primary)', fontSize: 14 }}>
            Browse Products
          </Link>
        </div>
      </div>
