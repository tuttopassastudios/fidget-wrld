  ...
  return (
    <section className={`product-page ${styles.pageSection}`}>
      <div className={`container ${styles.contentContainer}`}>
        ...
        <div className={styles.featureGrid}>
          <div className={styles.featureCard}>
            ...
            <h4 className={styles.featureTitle}>Safe Materials</h4>
          ...
          <div className={styles.featureCard}>
            ...
            <h4 className={styles.featureTitle}>Satisfaction First</h4>
          ...
          <div className={styles.featureCard}>
            ...
            <h4 className={styles.featureTitle}>Fast Shipping</h4>
          ...
          <div className={styles.featureCard}>
            ...
            <h4 className={styles.featureTitle}>Friendly Support</h4>
      ...
      <div className={`container ${styles.makersContainer}`}>
        ...
        <div className={dsStyles.designersGrid}>
